...
parser.add_argument(
    ...
    type=str,
    default="syn_data",
    help="where to store synthetic data for post",
)
parser.add_argument(
    "--val_dir",
    type=str,
    help="where to store validation data for post",
)
parser.add_argument(
    "--kd",
    type=str2bool,
...
if args.subset == "cifar10":
    args.train_dir = '/data/cifar10/train'
    args.val_dir ='/data/cifar10/val'
elif args.subset == "cifar100":
    args.train_dir = ''
    args.val_dir ='/DC3/cifar100/validation_by_class'
elif args.subset == "tinyimagenet":
    args.train_dir = "/DC3/tiny_imagenet/train_by_class"
    args.val_dir = "/DC3/tiny_imagenet/validation_by_class"
elif args.subset == "imagenet-nette":
    args.train_dir = ""
    args.val_dir = "/DC3/imagenette/validation_by_class"
elif args.subset == "imagenet-1k":
    args.train_dir = ""
    args.val_dir = "/data/ImageNet/val"
    #args.syn_data_path = args.syn-data-path
...
if args.re_batch_size == 0:
    if args.ipc == 50:
        ...
        args.workers = 0
    elif args.ipc >= 200 and args.subset == "cifar10":
        args.re_batch_size = 200
    elif args.ipc >= 500 and args.subset == "cifar10":
        args.re_batch_size = 400

    if args.nclass == 10:
        args.re_batch_size *= 5
    if args.nclass == 100:
        args.re_batch_size *= 2
    if args.nclass == 1000:
        args.re_batch_size *= (args.ipc)

    if args.subset == "cifar100":
        args.re_batch_size = 10*args.ipc*2
        if args.ipc == 1:
            args.re_batch_size = 50
    # ! tinyimagenet
    if args.subset == "tinyimagenet":
        args.re_batch_size = 10*5*args.ipc
        if args.ipc == 1:
            args.re_batch_size = 100

    if args.subset == "imagenet-1k":
        #args.re_batch_size = 10*5*args.ipc
        if args.ipc == 1:
            args.re_batch_size = 1000
        elif args.ipc == 10:
...
print("re_batch_size",args.re_batch_size)
