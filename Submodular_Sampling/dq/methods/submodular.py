        ...
        with self.model.embedding_recorder:
            ...
            if self.balance:
                ...
                for c in range(self.num_classes):
                    ...
                    #print("c",c,"len(c_indx)",len(c_indx),"c_indx[:10]",c_indx[:10])
                    ...
                    #print("c",c,"len(c_selection_result)",len(c_selection_result),"c_selection_result[:10]",c_selection_result[:10])
