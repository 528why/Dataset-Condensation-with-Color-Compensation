...
def main():
    ...
    parser.add_argument('--IPC', type=int, default=10, help='IAMGE PER CLASS')
    parser.add_argument('--K', type=int, default=10, help='Kmeans cluster num')
    # Selecting
    ...
    parser.add_argument('--cluster_path', type=str, default='', help='path to get cluster paths ')
